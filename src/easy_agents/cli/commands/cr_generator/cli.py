...
def generate_cr(target_branch: str) -> CodeReview:
    ...
    return CodeReview("EASY-AGENTS-BOT", [CodeReviewGeneralComment("")])
...
def cr(
    ...
    cache_dir: str = typer.Option(".cr.cache", envvar="EASY_AGENTS_CACHE_DIR", help="Directory to store cache files."),
